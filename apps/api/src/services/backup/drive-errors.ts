...
export const DRIVE_MESSAGES: Record<DriveFailureCode, { message: string; remedy: string }> = {
  NOT_CONFIGURED: {
    ...
    remedy:
      'يحتاج الربط إلى إعداد لمرة واحدة من مزوّد البرنامج. حتى ذلك الحين تُحفظ النسخ الاحتياطية على هذا الجهاز فقط — وهذا يعني أن عطلاً في القرص أو سرقة تُفقد كل شيء.',
  },
  NOT_CONNECTED: {
  ...
  EXPIRED: {
    ...
    remedy: 'أعد الربط بالضغط على «ربط حساب Google». لن تتأثّر النسخ المرفوعة سابقاً.',
  },
  AUTH_CLIENT: {
    message: 'إعدادات الربط مع Google غير صحيحة على هذا الجهاز.',
    remedy: 'اتصل بمزوّد البرنامج — هذه مشكلة في الإعداد وليست في حسابك أو في اتصالك.',
  },
  QUOTA: {
