...
| الـHub | Node.js وTypeScript مع Prisma وPostgreSQL (محسوم، القسم 22) | عزل التجار بمعرّف tenant في كل جدول |
...
| A13 | ربط محطة الولاء بجهاز من تطبيق المحطة نفسه، ثم تشغيل ضابط «إلزام المحطات بالربط بجهاز» (`security.require_paired_station`) | لا يعمل جهاز غير مربوط، ويوقف إبطالُ الجهاز المحطةَ في طلبها التالي. **لا يُغلق P1 إلا بعد إتمام الربط في تطبيق المحطة وتشغيل الضابط.** |
...
| P1 الأساس والـHub | محرك الإعدادات، الأدوار، المحطات، feature flags، الـHub والمزامنة، النسخ الاحتياطي | A9 وA11 وA13، ومزامنة صامدة أمام الانقطاع | كبير |
...
أكبر خطرين هما اعتماد المكافآت الفورية على دعم البيان للدفع المجزأ، وتعقيد المزامنة بين الـHub والخدمة المحلية؛ وكانت هناك عشرة قرارات مفتوحة تحتاج جواباً قبل P0 وP1، حُسم منها حتى 2026-09-23 الاسم التجاري وتقنية الـHub واستضافته (الأخيرة مشروطة باختبار الدفع من العراق).
...
| --- | --- | --- |
| الاسم التجاري والدومين | يحددهما صاحب المنتج | **الاسم محسوم (P0):** «ولاء» بالعربية وLoyalty بالإنجليزية. **الدومين ما زال مفتوحاً**، ويُحسم قبل طباعة أي بطاقة |
| استضافة الـHub | خادم خاص (VPS) أو منصة مُدارة | **محسوم (2026-09-23):** منصة مُدارة فيها Postgres ونسخ احتياطي تلقائي (Render أو Fly أو Railway) للبداية، مع إمكانية الانتقال إلى VPS لاحقاً. **مشروط باختبار وسيلة الدفع من العراق قبل البناء عليها:** Railway يقبل البطاقات الائتمانية فقط بنص وثائقه، وخيارات البطاقات العراقية المتاحة مدينة أو مسبقة الدفع، فيتقدّمه Render وFly في الترتيب. التفصيل في `CLAUDE.md` §13.21 |
...
| تقنية الـHub | Rust أو Node.js | **محسوم (2026-09-23):** Node.js وTypeScript مع Prisma وPostgreSQL — التقنية نفسها المستعملة في المشروع، لتُشارَك الأنواع والتحقق والاختبارات بدل كتابة العقد مرتين |
